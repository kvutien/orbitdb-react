/* 
 * export an object with default configuration of an OrbitDB database
 * 
 */
const DEFAULT_IPFS_CONFIG = {
    ...
    config: {
        Bootstrap: [
        // Bootstrap are peers that are loaded on instantiation
        ...
        Addresses: {
        Swarm: [
            // Swarms are peers that can connect and disconnect at any time
